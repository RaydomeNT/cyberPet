...
class Dog extends Pet {
    ...
    greet() {
        ...
        //add caps to stats so the maximum for any stat is 100
    ...
    play(){
        //add a randomise function so that using play has high chance for a possitive result and a low chance for a negative result
        ...
        //added warnings to let the player know if stats are getting low so they have the chance to take the appropriate action
